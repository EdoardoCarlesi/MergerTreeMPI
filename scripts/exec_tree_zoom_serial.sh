...
ls -r $base_catalog*$snap_num*particles > $temp_part
ls -r $base_catalog*$snap_num*halos > $temp_halo
ls -r $base_catalog*$snap_num*particles | grep -o '_[0-9][0-9][0-9]' > $temp_out
else
ls -r $base_catalog*$snap_num*particles >> $temp_part
ls -r $base_catalog*$snap_num*halos >> $temp_halo
ls -r $base_catalog*$snap_num*particles | grep -o '_[0-9][0-9][0-9]' >> $temp_out
